...
class TaskConditionedSharedExpert(nnx.Module):
    ...
    def __call__(self, x, direction_ids, current_mlp_dim=None, deterministic: bool = False):
        ...
        # mode='clip': avoids OOB boolean mask (tfl.zeros_like on i1 is illegal)
        # direction_ids is always 0 or 1, both in range, so clip is a safe no-op
        ...
        g = g_full[:, None, :dim] if x.ndim == 3 else g_full[:, :dim]
        b = b_full[:, None, :dim] if x.ndim == 3 else b_full[:, :dim]
...
# $PYTHON step2_merge_experts.py \
#     --weights weights_256.npz \
#     --use-calibration \
#       --calib-dataset phomt \
#       --calib-n 500 \
#       --model-msg ../pruned_models/submodel_512.msg \
#       --tokenizer-dir ../v7.2.2_step80000/t5-en-vi-tokenizer-20k-v3 \
#       --out weights_256_dense_phomt.npz

# step3_export_tflite.py \
#       --model-msg ./pruned_models/submodel_512.msg \
#       --tokenizer-dir ../v7.2.2_step80000/t5-en-vi-tokenizer-20k-v3 \
#       --track dense \
#       --mlp-dim 256 \
#       --calib-dataset phomt \
#       --calib-n 256 \
#       --out-dir tflite_dense_phomt/

# step4_validate.py \
#       --model-msg ../pruned_models/submodel_512.msg \
#       --tokenizer-dir ../v7.2.2_step80000/t5-en-vi-tokenizer-20k-v3 \
#       --encoder-tflite tflite_dense_phomt/encoder.tflite \
#       --decoder-tflite tflite_dense_phomt/decoder.tflite